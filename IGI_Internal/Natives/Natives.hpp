...
namespace IGI {
	enum class HASH
	{
		...
		MUSIC_SFX_VOLUME_SET = 0x495F30,
		MUSIC_VOLUME_SET = 0x495E70,
		...
		WEAPON_GUN_PICKUP = 0x45FFC0,
		WEAPON_AMMO_PICKUP = 0x45FF80,
		HUMAN_HIT_DAMAGE_GET = 0x416D80,
		HUMAN_VIEW_CAM = 0x463760,
